...
@section('page-actions')
    <a class="btn btn-ghost" href="{{ route('lists.receipt.create') }}" title="Criar lista a partir da foto do cupom fiscal">
...
.badge-open{font-size:.62rem;font-weight:600;padding:.1rem .4rem;border-radius:5px;background:var(--adim);color:var(--accent);border:1px solid rgba(45,212,191,.2)}
...
.icon-box-green{background:var(--adim);border:1px solid rgba(45,212,191,.2)}
