...
.tc.hl{border-color:rgba(56,189,248,.22);background:rgba(56,189,248,.04)}
...
.ppill:hover{background:rgba(56,189,248,.12)}
...
.completed-banner{background:var(--adim);border:1px solid rgba(56,189,248,.22);border-radius:var(--radius);padding:.85rem 1rem;margin-bottom:1.25rem;display:flex;align-items:center;gap:.65rem;font-size:.82rem;color:var(--accent)}
