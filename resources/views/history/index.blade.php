...
.hicon{width:34px;height:34px;border-radius:8px;background:var(--adim);border:1px solid rgba(56,189,248,.15);display:flex;align-items:center;justify-content:center;font-size:.85rem;flex-shrink:0}
