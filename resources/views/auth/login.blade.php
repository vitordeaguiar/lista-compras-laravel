...
<head>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    :root{--bg:#09090b;--bg1:#111113;--bg2:#18181b;--bg3:#27272a;--border:#3f3f46;--accent:#10b981;--accent2:#059669;--text:#fafafa;--text2:#a1a1aa;--text3:#71717a;--danger:#ef4444}
    ...
    body::before{content:'';position:fixed;inset:0;background:radial-gradient(ellipse 60% 40% at 70% 20%,rgba(16,185,129,.05) 0%,transparent 60%),radial-gradient(ellipse 50% 50% at 20% 80%,rgba(99,102,241,.04) 0%,transparent 60%);pointer-events:none}
...
<body>
    <div class="auth-card">
        <a class="logo" href="#">
            <div class="logo-icon">
                <svg width="16" height="16" viewBox="0 0 28 28" fill="none"><path d="M7 9h14M7 14h9M7 19h11" stroke="#09090b" stroke-width="2.5" stroke-linecap="round"/><circle cx="21" cy="19" r="3.5" fill="#09090b"/><path d="M19.5 19l1 1 2-2" stroke="#10b981" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </div>
