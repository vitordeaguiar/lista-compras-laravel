...
<head>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .verified-badge{display:inline-flex;align-items:center;gap:.35rem;background:rgba(45,212,191,.08);border:1px solid rgba(56,189,248,.22);border-radius:7px;padding:.3rem .7rem;font-size:.74rem;color:var(--accent);margin-bottom:1.1rem}
