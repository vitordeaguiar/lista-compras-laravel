...
.lcard-icon{width:36px;height:36px;border-radius:9px;background:var(--adim);border:1px solid rgba(45,212,191,.2);display:flex;align-items:center;justify-content:center;font-size:.95rem;flex-shrink:0}
...
/* Status badge */
.badge-open{display:inline-flex;align-items:center;gap:.25rem;font-size:.62rem;font-weight:600;padding:.08rem .38rem;border-radius:5px;background:var(--adim);color:var(--accent);border:1px solid rgba(45,212,191,.2)}
